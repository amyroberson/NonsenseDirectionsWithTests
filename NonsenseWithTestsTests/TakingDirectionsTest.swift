...
class TakingDirectionsTest: XCTestCase {
    ...
    //extra credit 1 examples to test
    ...
    // extra credit 3 examples to test
    ...
    //test for extra credit 1
    func testTakingDirectiionsxY() {
        let result = takingDirections(directions: xY)
        let expectedResult = (10, 10)
        XCTAssertEqual(result.x, expectedResult.0)
        XCTAssertEqual(result.y, expectedResult.1)
    }
    
    func testTakingDirectionsxY1() {
        let result = takingDirections(directions: xY1)
        let expectedResult = (-10, 10)
        XCTAssertEqual(result.x, expectedResult.0)
        XCTAssertEqual(result.y, expectedResult.1)
    }
    
    func testTakingDirectionsxY2() {
        let result = takingDirections(directions: xY2)
        let expectedResult = (0, 0)
        XCTAssertEqual(result.x, expectedResult.0)
        XCTAssertEqual(result.y, expectedResult.1)
    }
    
    func testTakingDirectionsdirections6() {
        let result = takingDirections(directions: directions6)
        let expectedResult = (0, -5)
        XCTAssertEqual(result.x, expectedResult.0)
        XCTAssertEqual(result.y, expectedResult.1)
    }
    
    func testTakingDirectionsdirections7() {
        let result = takingDirections(directions: directions7)
        let expectedResult = (0, -5)
        XCTAssertEqual(result.x, expectedResult.0)
        XCTAssertEqual(result.y, expectedResult.1)
    }
